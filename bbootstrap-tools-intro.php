...
<?php
/**             
* @package BBootstrap - bbootstrap-tools-intro.php
* @author Frank Cherry
* @copyright (c) 2019 Frank Cherry
* @creationDate 2019.12.29
* @developers 
* @lastRevision 2019.12.29
...
<body id="page-top" class="index">
	...
	echo block_svg_top_straight();
	echo block_svg_01();
	echo block_svg_02();
	echo block_svg_super3();
	echo block_svg_top();
	echo block_svg_bottom();
	echo block_svg_wave_nice();
